...
import claseMongoDB, claseRobot, claseVentosa, claseLuces, clasePinza, realsense2ros, claseGuia
import transforms as trs

parameters_path = '/home/'+user+'/arise-vulcanexus-enviroment/arise_ws/src/challenge2/fruit_picking/resource/parameters.json'
